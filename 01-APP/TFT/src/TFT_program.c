...
void TFT_voidInit (void){
    ...
    voidWriteCommand(0x11);/*SLEEP OUT*/
	MSTK_VidSetBusyWait(150000);
	voidWriteCommand(0x3A);/*Colour ID*/
	voidWriteData(0x05);/*Colour Paramter*/
	
	voidWriteCommand(0x29);/*Colour on*/
...
void TFT_voidFillDisplay (u16 copy_u16Colour){
	...
	voidSetAddress(0 ,TFT_MAX_X ,0 ,TFT_MAX_Y );
	for(Local_u16index=0;Local_u16index<20480;Local_u16index++)
	{
